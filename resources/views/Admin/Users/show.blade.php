...
<div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
    <div>
        ...
        <h1 class="text-2xl font-bold text-gray-900">
            User Details <span class="text-gray-400 font-mono text-lg ml-2">#{{ $user->id }}</span>
        </h1>
    </div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <x-card class="h-fit">
            ...
            <div class="space-y-6 leading-relaxed">
                ...
                <div>
                    ...
                    <p class="text-base font-medium">{{ $user->national_id }}</p>
                </div>
            </div>
        </x-card>
    </div>
    ...
    <div class="space-y-8">
        <x-card class="h-fit">
            <h2 class="text-lg font-semibold mb-6">Account Info</h2>
            <div class="space-y-5">
